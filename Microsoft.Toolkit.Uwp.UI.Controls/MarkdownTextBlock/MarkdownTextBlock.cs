...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
    ...
    public sealed partial class MarkdownTextBlock : Control, ILinkRegister, IImageResolver, ICodeBlockResolver
    {
        ...
        private long SchemeListPropertyToken { get; set; }
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            SchemeListPropertyToken = RegisterPropertyChangedCallback(SchemeListProperty, OnPropertyChanged);
        }
        ...
        private void OnUnloaded(object sender, RoutedEventArgs e)
        {
            ...
            UnregisterPropertyChangedCallback(SchemeListProperty, SchemeListPropertyToken);
            _rootElement = null;
        }
